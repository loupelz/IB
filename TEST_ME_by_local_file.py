...
histIngestionPlan.add(Plan(security=symbol('SPY'), barSize='1 min', fileName='STK,SPY,USD_1 min_40 D_indexOfDatetime.csv'))  # "histIngestionPlan.add" is used to add more Ingestion Plans
histIngestionPlan.add(Plan(security=symbol('SPY'), barSize='1 day', fileName='STK,SPY,USD_1 day_55 D_indexOfDatetime.csv'))  # "histIngestionPlan.add" is used to add more Ingestion Plans

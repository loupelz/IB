...
class ClientLocalBroker(CallBacks):
    ...
    def reqHistoricalDataWrapper(self, reqId, contract, endTime, goBack, barSize, whatToShow, useRTH, formatDate):
        ...
        try:
            ...
            self._log.info(__name__ + '::reqHistoricalDataWrapper: Cannot find ingested hist for security=%s endTime=%s goBack=%s barSize=%s' % (security, endTime, goBack, barSize))

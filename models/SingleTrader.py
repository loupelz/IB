...
class SingleTrader(object):
    ...
    def find_order(self, brokerName, accountCode, str_ibpyOrderId):
        ...
        if account.has_ibpyOrderId(str_ibpyOrderId):
            ...
            self._log.debug(__name__ + '::SingleTrader::find_order: account=%s does not have ibpyOrderId=%s' % (accountCode, str_ibpyOrderId))
            return None
    ...
    def get_accountCode_by_ibpyOrderId(self, str_brokerName, str_ibpyOrderId):
        ...
        self._log.error(__name__ + '::get_accountCode_by_ibpyOrderId: EXIT, cannot find accountCode by ibpyOrderId=%s' % (str_ibpyOrderId,))
